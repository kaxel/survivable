...
class PossessionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create possession" do
    assert_difference('Possession.count') do
      post possessions_url, params: { possession: { bonus: @possession.bonus, current_game_id: @possession.current_game_id, name: @possession.name } }
    end
  ...
  test "should update possession" do
    patch possession_url(@possession), params: { possession: { bonus: @possession.bonus, current_game_id: @possession.current_game_id, name: @possession.name } }
