...
class AdjustmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adjustment" do
    assert_difference('Adjustment.count') do
      post adjustments_url, params: { adjustment: { amount: @adjustment.amount, bonus: @adjustment.bonus, project_id: @adjustment.project_id } }
    end
  ...
  test "should update adjustment" do
    patch adjustment_url(@adjustment), params: { adjustment: { amount: @adjustment.amount, bonus: @adjustment.bonus, project_id: @adjustment.project_id } }
